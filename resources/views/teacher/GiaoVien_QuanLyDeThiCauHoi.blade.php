...
<head>
    ...
    <title>Giáo viên – Câu hỏi đề thi</title>
    ...
    <main class="main-content">
        ...
        <div class="content-box">
            ...
            <div style="margin-bottom:10px;font-size:13px">
                <a href="{{ route('teacher.de-thi') }}" style="color:var(--cerulean)">← Quay lại danh sách đề thi</a>
            </div>

            <div class="section-title blue">Quản lý câu hỏi trong đề thi</div>
            ...
            <div id="tab-4pa">
                <div class="q-split">
                            ...
                            <table class="tbl">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form method="POST"
                                                  action="{{ route('teacher.de-thi.cau-hoi.destroy', [$deThi->ID_MaDeThi, $q->ID_DeThiChiTiet]) }}"
                    ...
                    <div class="q-panel">
                        ...
                        <div class="q-panel-body">
                            @if (count($avail4PA) > 0)
                            <form method="POST" action="{{ route('teacher.de-thi.cau-hoi.store', $deThi->ID_MaDeThi) }}">
                                @csrf
