                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="white-space:nowrap">
                                <a href="{{ route('teacher.de-thi.cau-hoi', $dt->ID_MaDeThi) }}"
                                ...
                                <form method="POST"
                                      action="{{ route('teacher.de-thi.destroy', $dt->ID_MaDeThi) }}"
...
<div id="modalOverlay" class="modal-overlay" style="display:none" onclick="closeOnBackdrop(event)">
    <div class="modal-box" style="width:440px">
        ...
        <form id="modalForm" method="POST" action="{{ route('teacher.de-thi.store') }}">
            @csrf
...
<script>
    ...
    const storeUrl   = "{{ route('teacher.de-thi.store') }}";
    const updateBase = "{{ url('giao-vien/de-thi') }}";
